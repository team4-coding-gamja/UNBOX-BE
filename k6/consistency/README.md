...
- `scripts/run-case.sh`
  ...
  - Kafka 장애 자동 주입(20s down, 70s outage 기본값)
...
- 장애 주입
  - 설계: 테스트 20초 시점 Kafka down 70초
  - 구현: `run-case.sh` 기본값 `--failure-at-seconds 20`, `--broker-down-seconds 70`
- 유실 판정
