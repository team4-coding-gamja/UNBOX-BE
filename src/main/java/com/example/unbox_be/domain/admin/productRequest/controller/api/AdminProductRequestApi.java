...
@Tag(name = "Admin Product Request", description = "관리자 상품 요청 관리 API")
...
public interface AdminProductRequestApi {
    ...
    @GetMapping
    ResponseEntity<Page<AdminProductRequestListResponseDto>> getProductRequests(Pageable pageable);
