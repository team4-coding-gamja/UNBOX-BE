...
public interface OrderApi {
    ...
    @PostMapping
    ResponseEntity<ApiResponse<UUID>> createOrder(
    ...
    @GetMapping("/{orderId}")
    ResponseEntity<ApiResponse<OrderDetailResponseDto>> getOrderDetail(
    ...
    ResponseEntity<ApiResponse<OrderDetailResponseDto>> cancelOrder(
            @PathVariable UUID orderId,
            @Parameter(hidden = true) @AuthenticationPrincipal CustomUserDetails userDetails
    );
    ...
    ResponseEntity<ApiResponse<OrderDetailResponseDto>> registerTracking(
            @PathVariable UUID orderId,
    ...
    ResponseEntity<ApiResponse<OrderDetailResponseDto>> confirmOrder(
            @PathVariable UUID orderId,
            @Parameter(hidden = true) @AuthenticationPrincipal CustomUserDetails userDetails
    );
}