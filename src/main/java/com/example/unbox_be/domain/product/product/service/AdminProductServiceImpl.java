package com.example.unbox_be.domain.product.product.service;

import com.example.unbox_be.domain.product.product.dto.request.AdminProductCreateRequestDto;
import com.example.unbox_be.domain.product.product.dto.request.AdminProductUpdateRequestDto;
import com.example.unbox_be.domain.product.product.dto.request.ProductSearchCondition;
import com.example.unbox_be.domain.product.product.dto.response.AdminProductCreateResponseDto;
import com.example.unbox_be.domain.product.product.dto.response.AdminProductListResponseDto;
import com.example.unbox_be.domain.product.product.dto.response.AdminProductUpdateResponseDto;
import com.example.unbox_be.domain.product.product.entity.ProductOption;
import com.example.unbox_be.domain.product.product.mapper.AdminProductMapper;
...
import com.example.unbox_be.domain.product.product.repository.BrandRepository;
import com.example.unbox_be.domain.product.product.repository.ProductOptionRepository;
import com.example.unbox_be.domain.product.product.repository.ProductRepository;
