...
public interface SellingBidApi {
    ...
    @PostMapping
    ResponseEntity<UUID> createSellingBid(
            @RequestBody @Valid SellingBidRequestDto requestDto,
    ...
    @Operation(
            summary = "판매 입찰 취소",
            description = "로그인한 사용자가 본인의 판매 입찰을 취소합니다."
    )
    @ApiResponses({
    ...
    ResponseEntity<Void> cancelSellingBid(
            @Parameter(description = "판매 입찰 ID", required = true)
    ...
    @Operation(
            summary = "판매 입찰 가격 변경",
            description = "로그인한 사용자가 본인의 판매 입찰 가격을 변경합니다."
    )
    @ApiResponses({
    ...
    ResponseEntity<Void> updatePrice(
            @Parameter(description = "판매 입찰 ID", required = true)
            @PathVariable UUID sellingId,
    ...
    @Operation(
            summary = "판매 입찰 상세 조회",
            description = "판매 입찰 ID로 상세 정보를 조회합니다. (본인 입찰만 조회 가능)"
    )
    @ApiResponses({
    ...
    ResponseEntity<SellingBidResponseDto> getSellingBidDetail(
            @Parameter(description = "판매 입찰 ID", required = true)
            @PathVariable UUID sellingId,
    ...
    @Operation(
            summary = "내 판매 입찰 목록 조회",
            description = "로그인한 사용자의 판매 입찰 목록을 최신순으로 Slice 페이징 조회합니다."
    )
    @ApiResponses({
    ...
    @GetMapping("/my")
    ResponseEntity<Slice<SellingBidResponseDto>> getMySellingBids(
            @Parameter(hidden = true)
            @AuthenticationPrincipal CustomUserDetails userDetails,
