package com.example.unbox_be.domain.user.auth.controller.api;

import com.example.unbox_be.domain.user.auth.controller.TestBootstrapMasterController.CreateMasterRequest;
