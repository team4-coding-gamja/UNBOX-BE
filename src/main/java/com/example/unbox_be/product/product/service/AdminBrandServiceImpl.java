package com.example.unbox_be.product.product.service;

import com.example.unbox_be.product.product.dto.request.AdminBrandCreateRequestDto;
import com.example.unbox_be.product.product.dto.request.AdminBrandUpdateRequestDto;
import com.example.unbox_be.product.product.dto.response.AdminBrandCreateResponseDto;
import com.example.unbox_be.product.product.dto.response.AdminBrandDetailResponseDto;
import com.example.unbox_be.product.product.dto.response.AdminBrandListResponseDto;
import com.example.unbox_be.product.product.dto.response.AdminBrandUpdateResponseDto;
...
import com.example.unbox_be.product.product.mapper.AdminBrandMapper;
import com.example.unbox_be.product.product.entity.Brand;
import com.example.unbox_be.product.product.repository.BrandRepository;
import com.example.unbox_be.product.product.repository.ProductOptionRepository;
import com.example.unbox_be.product.product.repository.ProductRepository;
