...
# Payment Service - Local Development Setup Script

echo "🚀 Payment Service 로컬 개발 환경 설정을 시작합니다..."
...
if curl -f http://localhost:8085/actuator/health > /dev/null 2>&1; then
    echo "✅ Payment Service가 정상적으로 시작되었습니다!"
...
echo "   데이터베이스 접속: docker exec -it unbox-payment-postgres psql -U unbox_user -d unbox_payment_local"
echo ""