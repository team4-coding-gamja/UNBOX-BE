...
# Trade Service - Local Development Setup Script

echo "🚀 Trade Service 로컬 개발 환경 설정을 시작합니다..."
...
if curl -f http://localhost:8083/actuator/health > /dev/null 2>&1; then
    echo "✅ Trade Service가 정상적으로 시작되었습니다!"
...
echo "   데이터베이스 접속: docker exec -it unbox-trade-postgres psql -U unbox_user -d unbox_trade_local"
echo ""