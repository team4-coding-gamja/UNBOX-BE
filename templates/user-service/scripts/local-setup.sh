...
# User Service - Local Development Setup Script

echo "🚀 User Service 로컬 개발 환경 설정을 시작합니다..."
...
if curl -f http://localhost:8081/actuator/health > /dev/null 2>&1; then
    echo "✅ User Service가 정상적으로 시작되었습니다!"
...
echo "   데이터베이스 접속: docker exec -it unbox-user-postgres psql -U unbox_user -d unbox_user_local"
echo ""