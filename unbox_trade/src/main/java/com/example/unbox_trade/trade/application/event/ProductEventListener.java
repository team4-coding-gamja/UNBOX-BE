    ...
    public void handleProductEvents(ConsumerRecord<String, Object> record, Acknowledgment ack) {
        ...
        try {
            ...
            if (event instanceof BrandDeletedEvent brandDeletedEvent) {
                ...
                adminSellingBidService.deleteSellingBidsByOptionIds(brandDeletedEvent.deletedOptionIds(),
                        "PRODUCT_EVENT");
            ...
            // 2. 상품 삭제 이벤트
                ...
                adminSellingBidService.deleteSellingBidsByOptionIds(productDeletedEvent.deletedOptionIds(),
                        "PRODUCT_EVENT");
            ...
            // 3. 옵션 단건 삭제 이벤트
                ...
                adminSellingBidService.deleteSellingBidByOptionId(productOptionDeletedEvent.productOptionId(),
                        "PRODUCT_EVENT");
