package com.example.unbox_user.cart.application.service;
...
import com.example.unbox_user.cart.presentation.dto.request.CartCreateRequestDto;
import com.example.unbox_user.cart.presentation.dto.response.CartListResponseDto;
import com.example.unbox_user.cart.presentation.dto.response.CartCreateResponseDto;
import com.example.unbox_user.cart.domain.entity.Cart;
import com.example.unbox_user.cart.domain.repository.CartRepository;
...
public class CartServiceImpl implements CartService {
    ...
    public CartCreateResponseDto createCart(Long userId, CartCreateRequestDto requestDto) {
        ...
        SellingBidForCartInfoResponse sellingBidInfo = tradeClient
    ...
    private CartListResponseDto toResponseDto(Cart cart) {
        ...
        SellingBidForCartInfoResponse bid = tradeClient.getSellingBidForCart(cart.getSellingBidId());
